...
[![TGRS-2025-badge](https://img.shields.io/badge/IEEE%20TGRS-2025-blue.svg)](https://ieeexplore.ieee.org/document/11208172)
...
```
@ARTICLE{guo2025whatfrequency,
  author={Guo, Wen and Cai, Fulong and Quan, Wuzhou},
  journal={IEEE Transactions on Geoscience and Remote Sensing}, 
  title={What Is in the Frequency: Wavelet-Guided Semantic Understanding for Infrared Small Target Detection}, 
  year={2025},
  volume={63},
  number={},
  pages={1-14},
  keywords={Semantics;Frequency-domain analysis;Feature extraction;Object detection;Decoding;Noise reduction;Robustness;Image edge detection;Filters;Context modeling;Feature refinement;infrared small target detection (ISTD);semantic disentanglement;wavelet frequency domain},
  doi={10.1109/TGRS.2025.3623373}}
```
...
```bash
conda install python==3.9 torch==2.3.0 torchvision==0.18.0 torchaudio==2.3.0 pytorch-cuda==11.8 -c pytorch -c nvidia
...
A large part of the code is borrowed from [Wuzhou-Quan/HintU](https://github.com/Wuzhou-Quan/HintU).